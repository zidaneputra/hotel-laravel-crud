            ...
            <div class="col-lg-5 col-md-8 col-sm-12  mx-auto" style="z-index: 1">
                <div class="glassmorphism card-signin my-5">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h5 class="card-title text-center">PMM Hotel</h5>
                            </div>
                        </div>
...
<?php echo $__env->make('template.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zidane/Downloads/Laravel-Hotel-main/resources/views/auth/login.blade.php ENDPATH**/ ?>