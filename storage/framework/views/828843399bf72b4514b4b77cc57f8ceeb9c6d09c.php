<?php $__env->startSection('title', 'Count Person'); ?>
                            ...
                            <div class="card-body">
                                <form class="row g-3" method="GET"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control <?php $__errorArgs = ['count_person'];
...
unset($__errorArgs, $__bag); ?>"
                                            id="
                                                count_person" name="count_person" value="<?php echo e(old('count_person')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="
                                                check_in" name="check_in" value="<?php echo e(old('check_in')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="
                                                check_out" name="check_out" value="<?php echo e(old('check_out')); ?>">
...
<?php echo $__env->make('template.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zidane/Downloads/Laravel-Hotel-main/resources/views/transaction/reservation/viewCountPerson.blade.php ENDPATH**/ ?>