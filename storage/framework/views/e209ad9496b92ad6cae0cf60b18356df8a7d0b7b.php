    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="row mt-2 mb-2">
                ...
                <div class="col-lg-6 mb-2">
                    <form class="d-flex" method="GET" action="<?php echo e(route('user.index')); ?>">
                        ...
                        <input class="form-control me-2" type="search" placeholder="Search by name" aria-label="Search"
                            id="search-user" name="qu" value="<?php echo e(request()->input('qu')); ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <form class="btn btn-sm p-0 m-0" method="POST"
                                                        ...
                                                        <div class="btn btn-light btn-sm rounded shadow-sm border p-0 m-0 delete"
                                                            user-id="<?php echo e($user->id); ?>" user-name="<?php echo e($user->name); ?>"
            ...
            <div class="row justify-content-md-center mt-3">
                <div class="col-sm-10 d-flex mx-auto justify-content-md-center">
                    <div class="pagination-block">
                        <?php echo e($users->onEachSide(1)->appends(['customers' => $customers->currentPage(), 'qc' => request()->input('qc')])->links('template.paginationlinks')); ?>
        ...
        <div class="col-lg-6">
            <div class="row mt-2 mb-2">
                ...
                <div class="col-lg-6 mb-2">
                    <form class="d-flex" method="GET" action="<?php echo e(route('user.index')); ?>">
                        ...
                        <input class="form-control me-2" type="search" placeholder="Search by name" aria-label="Search"
                            id="search-user" name="qc" value="<?php echo e(request()->input('qc')); ?>">
                        <button class="btn btn-outline-dark" type="submit">Search</button>
                    </form>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover" style="white-space: nowrap">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td scope="row">
                                                ...
                                                <td>
                                                    ...
                                                    <form class="btn btn-sm p-0 m-0" method="POST"
                                                        ...
                                                        <a class="btn btn-light btn-sm rounded shadow-sm border p-0 m-0 delete"
                                                            href="#" user-id="<?php echo e($user->id); ?>" user-role="Customer"
                                                            user-name="<?php echo e($user->name); ?>" data-bs-toggle="tooltip"
                                                    ...
                                                    <a class="btn btn-light btn-sm rounded shadow-sm border p-0 m-0 disabled"
                                                        href="/user/detail/<?php echo e($user->id); ?>" data-bs-toggle="tooltip"
            ...
            <div class="row justify-content-md-center mt-3">
                <div class="col-sm-10 d-flex justify-content-md-center">
                    <?php echo e($customers->onEachSide(1)->appends(['users' => $users->currentPage(), 'qu' => request()->input('qu')])->links('template.paginationlinks')); ?>
...
<?php echo $__env->make('template.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zidane/Downloads/Laravel-Hotel-main/resources/views/user/index.blade.php ENDPATH**/ ?>