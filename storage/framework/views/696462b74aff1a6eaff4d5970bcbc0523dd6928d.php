        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border">
                ...
                <div class="card-body p-3">
                    <form class="row g-3" method="POST" action="<?php echo e(route('customer.store')); ?>"
...
unset($__errorArgs, $__bag); ?>" id="birthdate"
                                name="birthdate" value="<?php echo e(old('birthdate')); ?>">
...
<?php echo $__env->make('template.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zidane/Downloads/Laravel-Hotel-main/resources/views/customer/create.blade.php ENDPATH**/ ?>